<template>
	...
	<view :animation="animationData" class="uni-drawer" :class="{'uni-drawer-visible':option.visible,'uni-drawer-right':option.rightMode}">
		<!-- #endif -->
		<!-- #ifdef H5 -->
		<view :id="id" class="uni-drawer" :class="{'uni-drawer-visible':option.visible,'uni-drawer-right':option.rightMode}">
			<!-- #endif -->
			<!-- #ifndef APP-PLUS -->
			<view v-if="showmask" class="uni-drawer-mask" @tap.stop="close" @touchmove.stop="stopref" @touchend="stopref"></view>
			<!-- #endif -->
			<!-- #ifdef APP-PLUS -->
			<view v-if="showmask" class="uni-drawer-mask" @tap.stop="close"></view>
			<!-- #endif -->
