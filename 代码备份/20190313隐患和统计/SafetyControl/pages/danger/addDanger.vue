...
<!-- 		<view class="cellTitleView">
		...
		<view class="cellInfoView">
			...
			<uni-list>
				<uni-list-item title="隐患描述" :subnote="bhgys" show-arrow="true" @click="selectedbhgys"></uni-list-item>
				...
				<uni-list-item title="对应条款" :subnote="wfflfgjtk" show-arrow="true" @click="selectedwfflfgjtk"></uni-list-item>
