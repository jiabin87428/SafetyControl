...
<!-- 		<view class="cellTitleView">
		...
		<view class="cellInfoView">
			...
			<uni-list>
				<uni-list-item title="责任部门" :subnote="dangerDept" show-arrow="true" @click="selectedDept"></uni-list-item>
				<uni-list-item title="隐患级别" :subnote="dangerLevel" show-arrow="true" @click="selectedDangerLevel"></uni-list-item>
				<uni-list-item title="隐患后果" :subnote="dangerType" show-arrow="true" @click="selectedDangerType"></uni-list-item>
				<uni-list-item title="不合格因素" :subnote="dangerDesc" show-arrow="true" @click="selectedDangerDesc"></uni-list-item>
