	...
	<view class="container">
		...
		<hj-dragabledrawer :options="options">
            <view class="fliterView">
				<text class="fliterText">事件类型</text>
				<view class="pickerView">
					<picker @change="eventChange" :value="lx" :range="events">
						<view class="pickerItem">{{lx == '' ? '请选择事件类型' : lx}}</view>
					</picker>
				</view>
	...
	export default {
		...
		methods: {
			...
			getCountDate() {
				...
				request.requestLoading(config.alertDeviceCount, param, "正在查询统计数据", function(res){
